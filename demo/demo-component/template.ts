...
export const template = (props: DemoComponent) => html`
  <div id="test1">
    ...
    <uxl-content-switcher id="pages1" selected="0" duration="500" animation="slide">
  ...
  <div id="test2">
    ...
    <uxl-content-switcher id="pages2" attrForSelected="name" duration="1000" selected="view2" animation="stretch">
